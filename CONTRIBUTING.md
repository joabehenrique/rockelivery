...
Here we have a set of instructions and guidelines to reduce misunderstandings and make the process of contributing to `Exlivery` as smooth as possible.
...
As a user of `Exlivery`, you're the perfect candidate to help us improve our documentation!
...
- `bug` issuesare known bugs we'd like to fix;
- `enhancement` issues are features we're open to include.
...
When developing, prefer using the latest version of **Elixir\Erlang**.
...
For the pull request follow [this documentation](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request).
